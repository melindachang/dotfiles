;;; doom-tokyo-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme doom-tokyo
  ...
  (
   ...
   (default :foreground fg-alt :background bg)
   ...
   (tree-sitter-hl-face:keyword.module :foreground dark-cyan :slant 'normal)
   (tree-sitter-hl-face:keyword.operator :foreground dark-cyan :slant 'normal)
   (tree-sitter-hl-face:property :slant 'normal :foreground green)
   (tree-sitter-hl-face:property.definition :foreground green)
   ...
   (web-mode-css-function-face :foreground functions)
   ;;;; HTML
