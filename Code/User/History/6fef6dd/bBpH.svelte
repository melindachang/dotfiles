...
<style lang="scss">
  ...
  .filter {
    ...
    .filter__list {
      ...
      display: grid;
      row-gap: 8px;
      border-left: 0.5px solid $dotted-border-color;
      .filter__list__item {
        padding: 0;
        background: none;
        border: none;
