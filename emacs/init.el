...
(use-package emacs
  ...
  (set-face-attribute 'default nil :family "CommitMono Nerd Font Mono"  :height 110)
...
(use-package dired
  ...
  (dired-guess-shell-alist-user
   '(("\\.\\(png\\|jpe?g\\|tiff\\)" "imv" "xdg-open" "open") ;; Open image files with `feh' or the default viewer.
...
(use-package lsp-mode
  ...
  :straight t
  :defer t
  :hook ((bash-ts-mode . lsp)                           ;; Enable LSP for Bash
...
(use-package evil
  ...
  (evil-define-key 'normal 'global (kbd "<leader> /") 'consult-line)
	...
	;; Apheleia
	(evil-define-key 'normal 'global (kbd "<leader> c f") 'apheleia-format-buffer)
